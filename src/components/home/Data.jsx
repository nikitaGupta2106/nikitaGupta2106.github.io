...
const Data = () => {
  ...
  return (
    <div className="home__data">
      ...
      <h3 className="home__subtitle"> - {displayText}</h3>
      <p style={{ marginBottom: "15px" }}>
        Highly motivated and detail-oriented full stack developer. Passionate
        about delivering exceptional user experiences.
      </p>
